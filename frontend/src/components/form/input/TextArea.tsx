...
const TextArea: React.FC<TextareaProps> = ({
  ...
  const handleChange = (e: ChangeEvent<HTMLTextAreaElement>) => { // Use ChangeEvent from React
    if (onChange) {
  ...
  return (
    <div className="relative">
      <textarea
        ...
        rows={rows}
        value={value}
        onChange={handleChange} // This is the native textarea's onChange, which expects a ChangeEvent
        disabled={disabled}
